...
public class GridBagPane extends JPanel {
     ...
     *
     * @param file the name of the XML file that describes the pane's components and their postions
     */
     ...
     * @return the component with the given name,or null if no component in this grid bag panel has the given name
     */
    ...
    private void parseCell(Element e, int r, int c) {
        ...
        //use reflection to get integer valuse of static fields
        ...
        } catch (Exception ex) {//the reflections methods can throw various exceptions
            ex.printStackTrace();
        }
    ...
    private Object parseBean(Element e) {
        try {
            ...
            return obj;
        } catch (Exception ex) { //the reflection methods can throw various excepitions
            ex.printStackTrace();
            return null;
        }
    }
