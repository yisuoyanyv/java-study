package coreJavaVolume2AdvancedFeatures.script;
...
public class ScriptTest {
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                ...
                final String frameClassName = args.length < 2 ? "coreJavaVolume2AdvancedFeatures.script.buttons1.ButtonFrame" : args[1];
     ...
     * @param namedComponents a map into which to enter the compoent names and components
     */
     ...
     *
     * @param beanName   the name of the bean to which the listener shoud be added
     * @param eventName  the name of the listener type,such as "action" or "change"
     * @param scriptCode the script code to be execuetd
     * @param engine     the engine that executes the code
     * @param components the bindings for the execution
     * @throws ReflectiveOperationException
     * @throws IntrospectionException
     */
    private static void addListener(String beanName, String eventName, final String scriptCode, final ScriptEngine engine,
