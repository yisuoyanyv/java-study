package coreJavaVolumeFundamentals.preferences;
...
/**
 * A frame that restores position and size from user preferneces and updates the preferences upon exit.
 */
class PreferencesFrame extends JFrame {
    private static final int DEFAULT_WIDTH = 300;
    private static final int DEFAULT_HEIGHT = 200;
    private Preferences root = Preferences.userRoot();
    private Preferences node = root.node("/com/zjl/test");
